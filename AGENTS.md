# OceanLens India — Codex working context

> Maintained across sessions. Read this first; it should save you from re-reading the
> Codex Design project or re-probing data endpoints.
...
- **Gaps, stated plainly**:
  ...
  - No viewport narrower than 1440px was checked — this project's own locked layout
    decision (`AGENTS.md`'s "Locked decisions" #4) specifies only 300px-rail/1440x900 and
...
- **`docs/api.md`/AGENTS.md's Phase 5A step 1 entry can now be corrected**: the frontend's
...
- Both fixes are backend-internal; nothing about the frontend's honesty guarantees changed,
  ...
  documented in AGENTS.md as of this pass.
...
operational shell.** Ported from the Codex Design artboard structure documented in Phase 0.
...
the Codex Design reference → document known issues → report → *wait for explicit approval*.
No speculative cross-phase work.

## Source of the design

Codex Design project `02b36dfc-4d04-4d3e-8cc9-2252628d1e04`, read via the `DesignSync`
...
support.js                Codex Design canvas runtime           <- DO NOT ship; spec only
...
`/private/tmp/Codex-501/-Users-kshaunish/a3e34b40-8851-40eb-af8a-6372886a30d8/scratchpad/`
